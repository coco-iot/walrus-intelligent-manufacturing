...
--
-- Table structure for table `manufacturing_ad`
--

use manufacturing;

DROP TABLE IF EXISTS `manufacturing_ad`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `manufacturing_ad` (
...
--
-- Table structure for table `manufacturing_address`
--

DROP TABLE IF EXISTS `manufacturing_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `manufacturing_address` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `manufacturing_admin`
--

DROP TABLE IF EXISTS `manufacturing_admin`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `manufacturing_admin` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `manufacturing_aftersale`
--

DROP TABLE IF EXISTS `manufacturing_aftersale`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `manufacturing_aftersale` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `manufacturing_brand`
--

DROP TABLE IF EXISTS `manufacturing_brand`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `manufacturing_brand` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `manufacturing_cart`
--

DROP TABLE IF EXISTS `manufacturing_cart`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `manufacturing_cart` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `manufacturing_category`
--

DROP TABLE IF EXISTS `manufacturing_category`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `manufacturing_category` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `manufacturing_collect`
--

DROP TABLE IF EXISTS `manufacturing_collect`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `manufacturing_collect` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL DEFAULT '0' COMMENT '用户表的用户ID',
...
--
-- Table structure for table `manufacturing_comment`
--

DROP TABLE IF EXISTS `manufacturing_comment`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `manufacturing_comment` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `manufacturing_coupon`
--

DROP TABLE IF EXISTS `manufacturing_coupon`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `manufacturing_coupon` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `manufacturing_coupon_user`
--

DROP TABLE IF EXISTS `manufacturing_coupon_user`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `manufacturing_coupon_user` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL COMMENT '用户ID',
...
--
-- Table structure for table `manufacturing_feedback`
--

DROP TABLE IF EXISTS `manufacturing_feedback`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `manufacturing_feedback` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL DEFAULT '0' COMMENT '用户表的用户ID',
...
--
-- Table structure for table `manufacturing_footprint`
--

DROP TABLE IF EXISTS `manufacturing_footprint`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `manufacturing_footprint` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL DEFAULT '0' COMMENT '用户表的用户ID',
...
--
-- Table structure for table `manufacturing_goods`
--

DROP TABLE IF EXISTS `manufacturing_goods`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `manufacturing_goods` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `manufacturing_goods_attribute`
--

DROP TABLE IF EXISTS `manufacturing_goods_attribute`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `manufacturing_goods_attribute` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `manufacturing_goods_product`
--

DROP TABLE IF EXISTS `manufacturing_goods_product`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `manufacturing_goods_product` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `goods_id` int(11) NOT NULL DEFAULT '0' COMMENT '商品表的商品ID',
...
--
-- Table structure for table `manufacturing_goods_specification`
--

DROP TABLE IF EXISTS `manufacturing_goods_specification`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `manufacturing_goods_specification` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `goods_id` int(11) NOT NULL DEFAULT '0' COMMENT '商品表的商品ID',
...
--
-- Table structure for table `manufacturing_groupon`
--

DROP TABLE IF EXISTS `manufacturing_groupon`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `manufacturing_groupon` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `rules_id` int(11) NOT NULL COMMENT '团购规则ID，关联manufacturing_groupon_rules表ID字段',
  `user_id` int(11) NOT NULL COMMENT '用户ID',
...
--
-- Table structure for table `manufacturing_groupon_rules`
--

DROP TABLE IF EXISTS `manufacturing_groupon_rules`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `manufacturing_groupon_rules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `manufacturing_issue`
--

DROP TABLE IF EXISTS `manufacturing_issue`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `manufacturing_issue` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `manufacturing_keyword`
--

DROP TABLE IF EXISTS `manufacturing_keyword`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `manufacturing_keyword` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `manufacturing_log`
--
...
--
-- Table structure for table `manufacturing_notice`
--

DROP TABLE IF EXISTS `manufacturing_notice`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `manufacturing_notice` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `manufacturing_notice_admin`
--

DROP TABLE IF EXISTS `manufacturing_notice_admin`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `manufacturing_notice_admin` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `manufacturing_order_goods`
--

DROP TABLE IF EXISTS `manufacturing_order_goods`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `manufacturing_order_goods` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `manufacturing_permission`
--

DROP TABLE IF EXISTS `manufacturing_permission`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `manufacturing_permission` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `manufacturing_region`
--

DROP TABLE IF EXISTS `manufacturing_region`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `manufacturing_region` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `manufacturing_role`
--

DROP TABLE IF EXISTS `manufacturing_role`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `manufacturing_role` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `manufacturing_search_history`
--

DROP TABLE IF EXISTS `manufacturing_search_history`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `manufacturing_search_history` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL COMMENT '用户表的用户ID',
...
--
-- Table structure for table `manufacturing_storage`
--

DROP TABLE IF EXISTS `manufacturing_storage`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `manufacturing_storage` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `manufacturing_system`
--

DROP TABLE IF EXISTS `manufacturing_system`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `manufacturing_system` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `manufacturing_topic`
--

DROP TABLE IF EXISTS `manufacturing_topic`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `manufacturing_topic` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `manufacturing_user`
--

DROP TABLE IF EXISTS `manufacturing_user`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `manufacturing_user` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
/*!40101 SET character_set_client = @saved_cs_client */;
-- ALTER TABLE manufacturing.manufacturing_user CHANGE column nickname nickname VARCHAR(63) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
