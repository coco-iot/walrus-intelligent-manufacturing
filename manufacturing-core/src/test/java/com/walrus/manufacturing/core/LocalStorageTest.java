...
import com.walrus.manufacturing.core.storage.LocalStorage;
...
public class LocalStorageTest {
    ...
    public void test() throws IOException {
        ...
        localStorage.store(new FileInputStream(test), testFile.length(), "image/png", "manufacturing.png");
        Resource resource = localStorage.loadAsResource("manufacturing.png");
        String url = localStorage.generateUrl("manufacturing.png");
