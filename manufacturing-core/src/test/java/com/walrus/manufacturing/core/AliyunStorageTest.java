...
import com.walrus.manufacturing.core.storage.AliyunStorage;
...
public class AliyunStorageTest {
    ...
    public void test() throws IOException {
        ...
        aliyunStorage.store(new FileInputStream(test), testFile.length(), "image/png", "manufacturing.png");
        Resource resource = aliyunStorage.loadAsResource("manufacturing.png");
        String url = aliyunStorage.generateUrl("manufacturing.png");
