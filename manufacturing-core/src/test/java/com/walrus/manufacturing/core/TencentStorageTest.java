...
import com.walrus.manufacturing.core.storage.TencentStorage;
...
public class TencentStorageTest {
    ...
    public void test() throws IOException {
        ...
        tencentStorage.store(new FileInputStream(test), testFile.length(), "image/png", "manufacturing.png");
        Resource resource = tencentStorage.loadAsResource("manufacturing.png");
        String url = tencentStorage.generateUrl("manufacturing.png");
