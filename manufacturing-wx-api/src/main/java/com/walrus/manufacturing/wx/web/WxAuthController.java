...
import com.walrus.manufacturing.wx.util.StringUtil;
...
import com.walrus.manufacturing.db.service.CouponAssignService;
...
import com.walrus.manufacturing.wx.dto.WxLoginInfo;
import com.walrus.manufacturing.wx.service.CaptchaCodeManager;
...
public class WxAuthController {
    ...
    public Object login(@RequestBody String body, HttpServletRequest request) {
        ...
        List<ManufacturingUser> userList = userService.queryByUsername(username);
        ManufacturingUser user = null;
        if (userList.size() > 1) {
    ...
    public Object loginByWeixin(@RequestBody WxLoginInfo wxLoginInfo, HttpServletRequest request) {
        ...
        ManufacturingUser user = userService.queryByOid(openId);
        if (user == null) {
            user = new ManufacturingUser();
    ...
    public Object register(@RequestBody String body, HttpServletRequest request) {
        ...
        if(!StringUtils.isEmpty(wxCode)) {
            ...
            if (userList.size() == 1) {
                ManufacturingUser checkUser = userList.get(0);
    ...
    public Object reset(@RequestBody String body, HttpServletRequest request) {
        ...
        List<ManufacturingUser> userList = userService.queryByMobile(mobile);
        ManufacturingUser user = null;
        if (userList.size() > 1) {
            return ResponseUtil.serious();
        } else if (userList.size() == 0) {
