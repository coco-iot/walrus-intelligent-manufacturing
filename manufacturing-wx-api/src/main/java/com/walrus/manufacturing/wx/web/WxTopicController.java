...
public class WxTopicController {
    ...
    public Object list(@RequestParam(defaultValue = "1") Integer page,
        ...
        List<ManufacturingTopic> topicList = topicService.queryList(page, limit, sort, order);
    ...
    public Object detail(@NotNull Integer id) {
        ...
        List<ManufacturingGoods> goods = new ArrayList<>();
        for (Integer i : topic.getGoods()) {
            ManufacturingGoods good = goodsService.findByIdVO(i);
            if (null != good)
                goods.add(good);
        }
    ...
    public Object related(@NotNull Integer id) {
        List<ManufacturingTopic> topicRelatedList = topicService.queryRelatedList(id, 0, 4);
