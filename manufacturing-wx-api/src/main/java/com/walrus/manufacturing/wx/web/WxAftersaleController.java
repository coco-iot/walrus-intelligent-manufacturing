...
public class WxAftersaleController {
    ...
    public Object list(@LoginUser Integer userId,
        ...
        List<ManufacturingAftersale> aftersaleList = aftersaleService.queryList(userId, status, page, limit, sort, order);

        List<Map<String, Object>> aftersaleVoList = new ArrayList<>(aftersaleList.size());
        for (ManufacturingAftersale aftersale : aftersaleList) {
            List<ManufacturingOrderGoods> orderGoodsList = orderGoodsService.queryByOid(aftersale.getOrderId());
    ...
    public Object detail(@LoginUser Integer userId, @NotNull Integer orderId) {
        ...
        ManufacturingAftersale aftersale = aftersaleService.findByOrderId(userId, orderId);
     ...
     */
    @PostMapping("submit")
    public Object submit(@LoginUser Integer userId, @RequestBody ManufacturingAftersale aftersale) {
        if (userId == null) {
            return ResponseUtil.unlogin();
        }
     ...
     */
    @PostMapping("cancel")
    public Object cancel(@LoginUser Integer userId, @RequestBody ManufacturingAftersale aftersale) {
        if (userId == null) {
            return ResponseUtil.unlogin();
        }
        ...
        ManufacturingAftersale aftersaleOne = aftersaleService.findById(userId, id);
    ...
    private Object validate(ManufacturingAftersale aftersale) {
