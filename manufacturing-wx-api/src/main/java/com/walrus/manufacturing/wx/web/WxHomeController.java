...
public class WxHomeController {
    ...
    @Autowired
    private ManufacturingAdService adService;
    ...
    @Autowired
    private ManufacturingTopicService topicService;
    ...
    public Object cache(@NotNull String key) {
        if (!key.equals("manufacturing_cache")) {
    ...
    private List<Map> getCategoryList() {
        ...
        List<ManufacturingCategory> catL1List = categoryService.queryL1WithoutRecommend(0, SystemConfig.getCatlogListLimit());
        for (ManufacturingCategory catL1 : catL1List) {
            List<ManufacturingCategory> catL2List = categoryService.queryByPid(catL1.getId());
            List<Integer> l2List = new ArrayList<>();
            for (ManufacturingCategory catL2 : catL2List) {
                l2List.add(catL2.getId());
            }

            List<ManufacturingGoods> categoryGoods;
            if (l2List.size() == 0) {
