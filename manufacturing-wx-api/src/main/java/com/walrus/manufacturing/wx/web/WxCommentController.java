...
import com.walrus.manufacturing.db.service.ManufacturingCommentService;
import com.walrus.manufacturing.db.service.ManufacturingGoodsService;
import com.walrus.manufacturing.db.service.ManufacturingTopicService;
...
import com.walrus.manufacturing.wx.service.UserInfoService;
...
public class WxCommentController {
    ...
    private Object validate(ManufacturingComment comment) {
     ...
     */
    @PostMapping("post")
    public Object post(@LoginUser Integer userId, @RequestBody ManufacturingComment comment) {
        if (userId == null) {
    ...
    public Object list(@NotNull Byte type,
        ...
        List<ManufacturingComment> commentList = commentService.query(type, valueId, showType, page, limit);

        List<Map<String, Object>> commentVoList = new ArrayList<>(commentList.size());
        for (ManufacturingComment comment : commentList) {
