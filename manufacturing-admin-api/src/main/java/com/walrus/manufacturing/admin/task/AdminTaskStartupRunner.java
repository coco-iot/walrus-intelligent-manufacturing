...
public class AdminTaskStartupRunner implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        List<ManufacturingGrouponRules> grouponRulesList = rulesService.queryByStatus(GrouponConstant.RULE_STATUS_ON);
        for(ManufacturingGrouponRules grouponRules : grouponRulesList){
