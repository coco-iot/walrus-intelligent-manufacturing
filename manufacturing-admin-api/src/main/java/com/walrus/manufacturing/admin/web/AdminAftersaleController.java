...
import com.walrus.manufacturing.admin.service.LogHelper;
...
import com.walrus.manufacturing.db.util.AftersaleConstant;
...
import static com.walrus.manufacturing.admin.util.AdminResponseCode.ORDER_REFUND_FAILED;
...
public class AdminAftersaleController {
    ...
    @Autowired
    private ManufacturingGoodsProductService goodsProductService;
    @Autowired
    ...
    public Object list(Integer orderId, String aftersaleSn, Short status,
        ...
        List<ManufacturingAftersale> aftersaleList = aftersaleService.querySelective(orderId, aftersaleSn, status, page, limit, sort, order);
    ...
    @PostMapping("/recept")
    public Object recept(@RequestBody ManufacturingAftersale aftersale) {
        Integer id = aftersale.getId();
        ManufacturingAftersale aftersaleOne = aftersaleService.findById(id);
    ...
    public Object batchRecept(@RequestBody String body) {
        ...
        for(Integer id : ids) {
            ManufacturingAftersale aftersale = aftersaleService.findById(id);
            if(aftersale == null){
                continue;
            }
    ...
    @PostMapping("/reject")
    public Object reject(@RequestBody ManufacturingAftersale aftersale) {
        Integer id = aftersale.getId();
        ManufacturingAftersale aftersaleOne = aftersaleService.findById(id);
        if(aftersaleOne == null){
    ...
    @PostMapping("/refund")
    public Object refund(@RequestBody ManufacturingAftersale aftersale) {
        Integer id = aftersale.getId();
        ManufacturingAftersale aftersaleOne = aftersaleService.findById(id);
        if(aftersaleOne == null){
            return ResponseUtil.badArgumentValue();
        ...
        ManufacturingOrder order = orderService.findById(orderId);
