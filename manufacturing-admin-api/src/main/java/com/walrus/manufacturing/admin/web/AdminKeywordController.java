...
public class AdminKeywordController {
    ...
    @Autowired
    private ManufacturingKeywordService keywordService;
    ...
    public Object list(String keyword, String url,
        ...
        List<ManufacturingKeyword> keywordList = keywordService.querySelective(keyword, url, page, limit, sort, order);
        return ResponseUtil.okList(keywordList);
    }

    private Object validate(ManufacturingKeyword keywords) {
    ...
    @PostMapping("/create")
    public Object create(@RequestBody ManufacturingKeyword keyword) {
    ...
    public Object read(@NotNull Integer id) {
        ManufacturingKeyword keyword = keywordService.findById(id);
        return ResponseUtil.ok(keyword);
    }
    ...
    @PostMapping("/update")
    public Object update(@RequestBody ManufacturingKeyword keyword) {
        Object error = validate(keyword);
        if (error != null) {
            return error;
        }
    ...
    @PostMapping("/delete")
    public Object delete(@RequestBody ManufacturingKeyword keyword) {
