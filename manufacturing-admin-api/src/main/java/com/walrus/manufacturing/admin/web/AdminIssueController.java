...
public class AdminIssueController {
    ...
    public Object list(String question,
        ...
        List<ManufacturingIssue> issueList = issueService.querySelective(question, page, limit, sort, order);
        return ResponseUtil.okList(issueList);
    }

    private Object validate(ManufacturingIssue issue) {
    ...
    @PostMapping("/create")
    public Object create(@RequestBody ManufacturingIssue issue) {
    ...
    public Object read(@NotNull Integer id) {
        ManufacturingIssue issue = issueService.findById(id);
        return ResponseUtil.ok(issue);
    }
    ...
    @PostMapping("/update")
    public Object update(@RequestBody ManufacturingIssue issue) {
        Object error = validate(issue);
        if (error != null) {
            return error;
        }
    ...
    @PostMapping("/delete")
    public Object delete(@RequestBody ManufacturingIssue issue) {
