...
import com.walrus.manufacturing.admin.vo.CategoryVo;
import com.walrus.manufacturing.core.util.ResponseUtil;
import com.walrus.manufacturing.db.domain.ManufacturingCategory;
import com.walrus.manufacturing.db.service.ManufacturingCategoryService;
...
public class AdminCategoryController {
    ...
    public Object list() {
        ...
        List<ManufacturingCategory> categoryList = categoryService.queryByPid(0);
        for (ManufacturingCategory category : categoryList) {
            ...
            List<ManufacturingCategory> subCategoryList = categoryService.queryByPid(category.getId());
            for (ManufacturingCategory subCategory : subCategoryList) {
    ...
    private Object validate(ManufacturingCategory category) {
    ...
    @PostMapping("/create")
    public Object create(@RequestBody ManufacturingCategory category) {
    ...
    public Object read(@NotNull Integer id) {
        ManufacturingCategory category = categoryService.findById(id);
        return ResponseUtil.ok(category);
    }
    ...
    @PostMapping("/update")
    public Object update(@RequestBody ManufacturingCategory category) {
        Object error = validate(category);
        if (error != null) {
            return error;
        }
    ...
    @PostMapping("/delete")
    public Object delete(@RequestBody ManufacturingCategory category) {
    ...
    public Object catL1() {
        ...
        for (ManufacturingCategory category : l1CatList) {
