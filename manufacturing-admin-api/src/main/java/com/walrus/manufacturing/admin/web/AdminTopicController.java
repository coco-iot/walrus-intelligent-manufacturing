...
public class AdminTopicController {
    ...
    public Object list(String title, String subtitle,
        ...
        List<ManufacturingTopic> topicList = topicService.querySelective(title, subtitle, page, limit, sort, order);
        return ResponseUtil.okList(topicList);
    }

    private Object validate(ManufacturingTopic topic) {
    ...
    @PostMapping("/create")
    public Object create(@RequestBody ManufacturingTopic topic) {
    ...
    public Object read(@NotNull Integer id) {
        ManufacturingTopic topic = topicService.findById(id);
        Integer[] goodsIds = topic.getGoods();
        List<ManufacturingGoods> goodsList = null;
    ...
    @PostMapping("/update")
    public Object update(@RequestBody ManufacturingTopic topic) {
        Object error = validate(topic);
        if (error != null) {
            return error;
        }
    ...
    @PostMapping("/delete")
    public Object delete(@RequestBody ManufacturingTopic topic) {
