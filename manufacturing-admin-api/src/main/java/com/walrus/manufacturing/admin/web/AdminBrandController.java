...
import com.walrus.manufacturing.db.service.ManufacturingBrandService;
...
public class AdminBrandController {
    ...
    public Object list(String id, String name,
        ...
        List<ManufacturingBrand> brandList = brandService.querySelective(id, name, page, limit, sort, order);
        return ResponseUtil.okList(brandList);
    }

    private Object validate(ManufacturingBrand brand) {
    ...
    @PostMapping("/create")
    public Object create(@RequestBody ManufacturingBrand brand) {
    ...
    public Object read(@NotNull Integer id) {
        ManufacturingBrand brand = brandService.findById(id);
        return ResponseUtil.ok(brand);
    }
    ...
    @PostMapping("/update")
    public Object update(@RequestBody ManufacturingBrand brand) {
        Object error = validate(brand);
        if (error != null) {
            return error;
        }
    ...
    @PostMapping("/delete")
    public Object delete(@RequestBody ManufacturingBrand brand) {
