...
import com.walrus.manufacturing.core.util.bcrypt.BCryptPasswordEncoder;
...
import static com.walrus.manufacturing.admin.util.AdminResponseCode.ADMIN_INVALID_ACCOUNT;
...
public class AdminProfileController {
    ...
    public Object lsNotice(String title, String type,
        ...
        List<ManufacturingNoticeAdmin> noticeList = noticeAdminService.querySelective(title, type, getAdminId(), page, limit, sort, order);
    ...
    public Object catNotice(@RequestBody String body) {
        ...
        ManufacturingNoticeAdmin noticeAdmin = noticeAdminService.find(noticeId, getAdminId());
        if(noticeAdmin == null){
        ...
        ManufacturingNotice notice = noticeService.findById(noticeId);
        ...
        if(adminId.equals(0)){
            ...
            ManufacturingAdmin admin = adminService.findById(notice.getAdminId());
